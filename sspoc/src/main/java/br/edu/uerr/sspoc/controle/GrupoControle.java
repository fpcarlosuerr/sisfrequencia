 ...
 */
@Stateless
public class GrupoControle extends AbstractControle {
    ...
    public void remover(Grupo entity) throws Exception {
        try {
    ...
    public Grupo pegarGrupoPeloId(Integer id) throws Exception{
        try {
